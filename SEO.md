...
正式網址： https://1ch666.github.io/eduai/
...
- robots.txt 在 Cloudflare 根目錄生效；GitHub Pages 專案路徑 `/eduai/robots.txt` 不能控制網域根目錄的爬蟲規則。可在 Search Console 驗證網站後提交 `https://1ch666.github.io/eduai/sitemap.xml`。本次未自動驗證 Search Console 或申請索引。
